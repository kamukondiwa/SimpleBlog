namespace Leatn.Framework.Contracts.Specifications
{
    ...
    /// </summary>
    /// <typeparam name="T">
    /// Type that the specification is applied to
    /// </typeparam>
    public interface ISpecification<T>
    {
        ...
        /// </param>
        /// <returns>
        /// Specification object containing original specification and new addition
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// Whether the specification has be satisfied
        /// </returns>
